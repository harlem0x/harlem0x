...
Atualmente estou aprendendo e desenvolvendo projetos voltados para **QA (Quality Assurance)**, além de aprofundar meus conhecimentos em **desenvolvimento web** (HTML, CSS, JavaScript).  
Sempre em busca de novos desafios que me ajudem a crescer profissionalmente e pessoalmente.  
...
- ⚡ Apache JMeter (Performance e Carga)  
...
⭐ Se gostou, não esqueça de deixar um **follow** no meu perfil para acompanhar minha evolução!
